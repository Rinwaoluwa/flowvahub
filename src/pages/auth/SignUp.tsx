            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-soft-lg p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">Start organizing your tools and earning rewards</p>
                    </div>
                    ...
                    <p className="text-center text-gray-600 text-sm mt-6">
                        ...
                        <Link to="/auth/signin" className="text-brand-purple font-medium hover:underline">
                            Sign in
                        </Link>
                    </p>
                </div>
