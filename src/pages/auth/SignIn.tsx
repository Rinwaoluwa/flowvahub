            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-soft-lg p-8">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl text-[#6D28D9] font-bold  mb-[8px] text-center w-full">Log in to flowva</h1>
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                        ...
                        <Button type="submit" className="w-full h-[55px] gap-2 flex justify-center text-base items-center p-[11px] text-center !bg-[#9013FE] text-white  font-medium border-none transition-colors ease-linear duration-[.2s] rounded-[100px] !hover:bg-[#6D28D9]" fullWidth loading={loading}>
                            Sign in
                        </Button>
                    </form>
                    ...
                    <p className="text-center text-gray-600 text-sm mt-6">
                        ...
                        <Link to="/auth/signup" className="text-brand-purple font-medium hover:underline">
                            Sign up
                        </Link>
                    </p>
                </div>
