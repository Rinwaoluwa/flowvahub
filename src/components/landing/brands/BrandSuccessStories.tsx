...
export function BrandSuccessStories() {
    return (
        <div className="mb-16 px-[14px]">
                ...
                <div className="w-full md:max-w-[80%] overflow-x-auto pb-4 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
                    <div className="flex gap-[30px]" style={{ width: 'max-content' }}>
                        ...
                        <div className="p-6 rounded-xl shadow-md flex flex-col justify-between w-[324px] h-fit" style={{ backgroundColor: 'rgb(93, 255, 233)' }}>
                            ...
                            <div className="flex gap-2 items-center">
                                <div className="h-10 w-10 justify-center items-center flex rounded-full bg-white">
                                    <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="22.6001" cy="22.25" r="20.5" stroke="#535862" strokeWidth="3"></circle><path d="M37.0956 7.75451C39.107 9.76592 39.7308 13.163 38.6472 17.3771C37.5732 21.5534 34.8709 26.2427 30.7316 30.3819C26.5924 34.5212 21.9031 37.2235 17.7268 38.2975C13.5127 39.3811 10.1156 38.7573 8.10422 36.7459C6.09281 34.7345 5.46896 31.3374 6.55259 27.1233C7.62658 22.947 10.3289 18.2577 14.4682 14.1185C18.6074 9.97922 23.2967 7.27688 27.473 6.20288C31.6871 5.11926 35.0842 5.74311 37.0956 7.75451Z" stroke="#535862" strokeWidth="3"></path><path d="M8.10412 7.7545C10.1155 5.7431 13.5126 5.11925 17.7267 6.20287C21.903 7.27687 26.5923 9.97921 30.7315 14.1185C34.8708 18.2577 37.5731 22.947 38.6471 27.1233C39.7308 31.3374 39.1069 34.7345 37.0955 36.7459C35.0841 38.7573 31.687 39.3811 27.4729 38.2975C23.2966 37.2235 18.6073 34.5212 14.4681 30.3819C10.3288 26.2427 7.62649 21.5534 6.55249 17.3771C5.46887 13.163 6.09271 9.76591 8.10412 7.7545Z" stroke="#535862" strokeWidth="3"></path></svg>
                                </div>
                                <h4 className="font-semibold text-[20px]">@Teamtoolkit</h4>
                            </div>
                        </div>
                    </div>
                </div>
