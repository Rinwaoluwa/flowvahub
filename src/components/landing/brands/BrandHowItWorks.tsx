                ...
                <div className="flex justify-center">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 w-full">
                        <div className="h-fit md:h-[628px] col-span-1 p-[20px] md:p-[40px] overflow-hidden rounded-[16px] md:rounded-[24px] bg-[#F77A38] w-full ">
                            ...
                            <div className="mt-10 bg-white/20 rounded-xl overflow-hidden h-64 w-full flex items-center justify-center">
                                <PlaceholderImage text="Subscribe 3D Icon" width="100%" height="100%" bgColor="bg-transparent" />
                            </div>
                        </div>
                        <div className="h-fit md:h-[628px] col-span-1 p-[20px] md:p-[40px] overflow-hidden rounded-[16px] md:rounded-[24px] bg-[#BC71FE] w-full ">
                            ...
                            <div className="mt-8 bg-white/20 rounded-xl overflow-hidden h-64 w-full flex items-center justify-center">
                                <PlaceholderImage text="Launch 3D Icon" width="100%" height="100%" bgColor="bg-transparent" />
                            </div>
                        </div>
                        <div className="h-fit md:h-[628px] col-span-1 p-[20px] md:p-[40px] overflow-hidden rounded-[16px] md:rounded-[24px] bg-[#F76593] w-full ">
                            ...
                            <div className="mt-10 bg-white/20 rounded-xl overflow-hidden h-64 w-full flex items-center justify-center">
                                <PlaceholderImage text="Speaker 3D Icon" width="100%" height="100%" bgColor="bg-transparent" />
                            </div>
                        </div>
                        <div className="h-fit md:h-[628px] col-span-1 p-[20px] md:p-[40px] overflow-hidden rounded-[16px] md:rounded-[24px] bg-[#008753] w-full ">
                            ...
                            <div className="mt-10 bg-white/20 rounded-xl overflow-hidden h-64 w-full flex items-center justify-center">
                                <PlaceholderImage text="Track 3D Icon" width="100%" height="100%" bgColor="bg-transparent" />
                            </div>
                        </div>
                        <div className="h-fit md:min-h-[378px] col-span-1 lg:col-span-2 p-[20px] md:p-[40px] overflow-hidden rounded-[16px] md:rounded-[24px] bg-[#159481] w-full ">
                            ...
                            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
                                ...
                                <div className="lg:-mt-10 bg-transparent rounded-xl overflow-hidden h-40 w-40 flex items-center justify-center">
                                    <PlaceholderImage text="Crown 3D Icon" width="100%" height="100%" bgColor="bg-transparent opacity-50" />
                                </div>
                            </div>
                        </div>
                    </div>
